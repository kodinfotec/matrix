...
##CONFIGURAÇÕES
####  TITULO DO MENU  #################################################################
title_menu = 'Bem Vindos ao Infotec Online Matrix'
###  DESCRIÇÃO DO ADDON ###############################################################
...
## MENU CONFIGURAÇÕES
menu_configuracoes = '[COLOR white]Configurações[/COLOR]'
thumb_icon_config = ''
desc_configuracoes = ''
## FAVORITOS
menu_favoritos = '[COLOR white]Favoritos[/COLOR]'
thumb_favoritos = ''
desc_favoritos = ''
...
################################################################
## MULTLINK
multlinkdialog = '[I] [ BY [B][COLOR=orange]INFOTEC[/COLOR]–[COLOR blue]KODI[/COLOR]–[COLOR lime]ONLINE[/COLOR] ® [/B] ][/I] [COLOR white] Selecione um item:[/COLOR]'
multilinktag = '$nortv='
color_multilink = 'blue'
